...
<html lang="en">
  ...
  <body>
              ...
              echo'
                ...
                <div class="col-md-4">
                  <div class="thumbnail">
                    ...
                    <div class="caption">
                      <h3>iPhone6</h3>
                      <p><strong>Seller : </strong>Steve2345</p>
	...
	<div>
        ...
        <div class="col-md-10 col-md-offset-1 border-shadow border-radius" style="background-color:white">
          <ol style="list-style-type:none; padding-left: 0px">
            ...
            <li class="watchlist" style="border-bottom:solid #c9c9c9 1px; padding-bottom: 30px">
              <div class="row">
                ...
                <div class="col-md-5">
                  <input type="text" class="form-control" id="inputDirectSaleSearch" placeholder="History search...">
                </div>
            ...
            <li class="watchlist" style="border-bottom:solid #c9c9c9 1px; padding-bottom: 30px">
              <div class="row">
                <div class="col-md-3">
                  <img src="assets/img/iphone6.jpg" width="185" height="104">
                </div>
                <div class="col-md-4">
                  <h3>iPhone 6</h3>
                ...
                <div class="col-md-5">
                  <div class="row" style="padding-top:10px">
                    <div class="col-md-5">
                      <strong>Seller: </strong>Steve123456<br>
                    </div>
                  
                    <div class="col-md-6">
                      <img src="assets/img/3stars.png" width="150" height="20">
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-10">
                      <div class="row">
                        ...
                        <div class="col-md-5" style="left:0%; padding-right:0px">
                          <input style="width:100%;padding-right:20px" type="text" class="form-control" id="inputEmail" placeholder="Enter max bid" >
                        </div>
            ...
            <li class="watchlist" style="border-bottom:solid #c9c9c9 1px; padding-bottom: 30px">
              <div class="row">
                ...
                <div class="col-md-4">
                  <h3>iPhone 6</h3>
                  <strong>Due date: </strong>12 Dec 14<br>
                  <a href="#">more info...</a>
                </div>
                <div class="col-md-5">
                  <div class="row" style="padding-top:10px">
                    <div class="col-md-12">
                      <strong>current bid: </strong>100 bath<br><strong>time left: </strong>18 hr
                    </div>
                  </div>
                  <div class="row">
                    <br>
