...
Class transaction_m extends CI_Model {
	...
	function getHistoryCustTransaction($buyer_id){
		return  $this->db->query("Select transaction_id, product_id, product.image, product.name as product_name, status, transaction.price, transaction.Seller_Score, transaction.Seller_Feedback,  transaction.quantity, user.username as seller_name 
			from transaction 
